...
public:
  ...
  // [PoLi] internet OTA — pull firmware from meshcore.epila.pl
  virtual bool startInternetOTA(const char* firmware_version, char reply[]) { return false; }
  virtual bool checkInternetOTA(const char* firmware_version, char reply[]) { return false; }
